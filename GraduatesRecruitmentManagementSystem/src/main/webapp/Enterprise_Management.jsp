        ...
        <div class="col-md-12">
            ...
            <table id="myTable">
                <c:forEach items="${requestScope.list}" var="e">
                    <tr>
                        <td></td>
                        <td>${e.enterprise_id}</td>
                        <td>${e.enterprise_name}</td>
                        <td>${e.enterprise_address}</td>
                        <td>${e.enterprise_contact}</td>
                        <td>${e.enterprise_phone}</td>
                        <td>${e.enterprise_email}</td>
                        <td>${e.enterprise_website}</td>
                        <td>${e.enterprise_scale}</td>
                        <td>${e.enterprise_nature}</td>
                        <td>${e.enterprise_desc}</td>
                        <td><a href="/EnterpriseMana_UpdataServlet?get=${e.enterprise_id}">${e.enterprise_state}</a></td>
                        <td>删除</td>
                    </tr>
...
<script type="text/javascript">
    function cli(id){
        ...
        if(flag){
            ...
            window.location.href="/EnterpriseMana_DelServlet?get="+id;
        }else{
